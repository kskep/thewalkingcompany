...
<article class="product-card"
    ...
    <div class="card-footer">
        <?php
        if ($is_variable) {
            // For variable products, always link to product page
            ?>
            <a href="<?php echo esc_url( get_permalink() ); ?>" class="add-to-cart variable-product">
                <?php echo esc_html__( 'Select Options', 'woocommerce' ); ?>
            </a>
            <?php
        } else {
            // For simple products, use default WooCommerce button
            woocommerce_template_loop_add_to_cart(array('class' => 'add-to-cart'));
        }
        ?>
    </div>
</article>