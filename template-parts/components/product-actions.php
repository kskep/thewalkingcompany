...
<div class="product-actions-container">
    ...
    <div class="action-buttons-row">
        ...
        <button type="button" class="btn-primary add-to-cart-btn" 
            ...
            <span class="btn-text"><?php _e('ADD TO CART', 'eshop-theme'); ?></span>
        ...
        <button type="button" class="btn-secondary wishlist-btn" 
            ...
            <span class="wishlist-text"><?php echo $is_in_wishlist ? __('Favorites', 'eshop-theme') : __('Add to favorites', 'eshop-theme'); ?></span>
        </button>
    </div>
    ...
    <?php if ($product->managing_stock() && $product->get_stock_quantity() > 0) : ?>
        ...
        <div class="stock-quantity">
            <span class="quantity-label"><?php _e('Available:', 'eshop-theme'); ?></span>
