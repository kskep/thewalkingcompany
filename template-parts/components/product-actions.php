...
<div class="product-actions-container">
    ...
    <div class="action-buttons-row">
        ...
        <button type="button" class="btn-primary add-to-cart-btn" 
            ...
            <span class="btn-text"><?php _e('ΠΡΟΣΘΗΚΗ ΣΤΟ ΚΑΛΑΘΙ', 'thewalkingtheme'); ?></span>
        ...
        <button type="button" class="btn-secondary wishlist-btn" 
            ...
            <span class="wishlist-text"><?php echo $is_in_wishlist ? __('Αγαπημένα', 'thewalkingtheme') : __('Προσθήκη στα αγαπημένα', 'thewalkingtheme'); ?></span>
        </button>
    </div>
    ...
    <div class="product-availability" id="product-availability">
        <?php if ($product->is_in_stock()) : ?>
            <span class="stock-status in-stock">
                ...
                <?php _e('Σε απόθεμα', 'thewalkingtheme'); ?>
            </span>
        <?php else : ?>
            <span class="stock-status out-of-stock">
                ...
                <?php _e('Εξαντλήθηκε', 'thewalkingtheme'); ?>
            </span>
        <?php endif; ?>
    </div>
    ...
    <?php if ($product->managing_stock() && $product->get_stock_quantity() > 0) : ?>
        ...
        <div class="stock-quantity">
            <span class="quantity-label"><?php _e('Διαθέσιμα:', 'thewalkingtheme'); ?></span>
            <span class="quantity-value"><?php echo esc_html($stock_quantity); ?></span>
            <?php if ($stock_quantity <= 5) : ?>
                <span class="low-stock-notice"><?php _e('Χαμηλό απόθεμα!', 'thewalkingtheme'); ?></span>
            <?php endif; ?>
        </div>
    <?php endif; ?>
