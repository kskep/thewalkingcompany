...
<div class="eshop-minicart-inner p-6 sm:p-7 bg-white text-left h-full flex flex-col">
    <!-- Header -->
    <div class="flex items-center justify-between mb-5 pb-4 border-b border-gray-100 flex-shrink-0">
        <h3 class="text-xl font-semibold text-gray-900 tracking-tight flex items-center gap-2">
            <?php _e('Shopping Cart', 'eshop-theme'); ?>
            <span class="bg-gray-100 text-gray-600 text-[11px] font-semibold px-2 py-0.5 rounded-full"><?php echo $cart_count; ?></span>
        </h3>
                        ...
                        <div class="minicart-item flex gap-4 group pb-4 border-b border-gray-50 last:border-b-0 last:pb-0" data-cart-item-key="<?php echo esc_attr($cart_item_key); ?>">
                            ...
                            <div class="flex-1 min-w-0 flex flex-col">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <button class="remove-from-cart text-gray-300 hover:text-red-500 transition-colors p-1 rounded-full hover:bg-red-50 flex-shrink-0" data-cart-item-key="<?php echo esc_attr($cart_item_key); ?>" aria-label="Remove item">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    ...
                                    <!-- Qty Controls -->
                                    <div class="minicart-qty-controls flex items-center bg-gray-50 border border-gray-200 rounded-md w-max h-8">
                                        <button type="button" class="minicart-qty-btn qty-minus w-8 h-full flex items-center justify-center text-gray-500 hover:text-primary hover:bg-white rounded-l-md transition-all focus:outline-none" data-cart-item-key="<?php echo esc_attr($cart_item_key); ?>" aria-label="Decrease quantity">
                                            <i class="fas fa-minus text-[0.55rem]"></i>
                                        </button>
                                        <span class="qty-value w-9 text-center text-sm font-semibold text-gray-900"><?php echo $cart_item['quantity']; ?></span>
                                        <button type="button" class="minicart-qty-btn qty-plus w-8 h-full flex items-center justify-center text-gray-500 hover:text-primary hover:bg-white rounded-r-md transition-all focus:outline-none" data-cart-item-key="<?php echo esc_attr($cart_item_key); ?>" aria-label="Increase quantity">
                                            <i class="fas fa-plus text-[0.55rem]"></i>
                                        </button>
                                    </div>
                                </div>
                            </div>
